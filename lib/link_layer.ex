defmodule LinkLayer do
  # API
  def start_link(group_name) do LinkLayerDistr.start_link(group_name) end
  def send(ll, data, node, broadcast_name) do GenServer.call(ll, {:send, data, node, broadcast_name}) end
